...
<body>
		...
		<div id="services" class="clear">
			...
			<div class="row">
				<c:forEach var="vo" items="${list }">
					<div class="col-md-3">
						<div class="thumbnail">
							<a href="../recipe/recipe_detail.do?no=${vo.no }"> <img
								src="${vo.poster }" alt="Lights" style="width: 100%">
								<div class="caption">
									<p>${vo.title }</p>
									<p>
										<sub style="color: gray">${vo.chef }</sub>
									</p>
								</div>
							</a>
						</div>
	...
	<div class="wrapper row6">
		...
		<div class="three_quarter first">
			...
			<p>${count}개의맛있는레시피가 있습니다.</p>
		</div>
		<div class="one_quarter">
			<a class="btn" href="#">Get it now <span
		...
		<div class="latest">
			...
			<ul class="nospace group">
				<c:forEach var="vo" items="${rlist }">
					<li><figure> <a class="overlay" href="#"><img
							src="${vo.poster}" alt=""></a> <figcaption
							class="inspace-30 center">
						<p class="bold uppercase">${vo.title}</p>
						<p style="color: #FC6">${vo.chef}</p>
						<p>
							<a href="#">View Here &raquo;</a>
						</p>
