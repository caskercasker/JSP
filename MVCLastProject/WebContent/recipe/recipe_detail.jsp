...
<!-- <link href="../main/layout/styles/layout.css" rel="stylesheet"
	...
	<div class="wrapper row2">
		<div id="services" class="clear">
			...
			<div class="row">
				<c:if test="${count!=0 }">
					<div class="thumbnail">
						<img src="${vo.poster}" alt="Lights"
							style="width: 800px; hgith: 350px;">
						<div class="caption">
							<p class="text-center">
								<img src="${vo.chef_poster}" width=50 height=50;
									class="img-circle" />
							</p>
					...
					<table class="table">
						<tr>
							<td class="text-center" colspan="3"><b>${vo.title }</b></td>
						</tr>
						<tr>
							<td class="text-center" colspan="3"><font color="maroon">${vo.content }</font>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="3"><c:forTokens items="${vo.foodmake }"
									delims="@" var="s">
									${s }<br>
								</c:forTokens></td>
						</tr>
