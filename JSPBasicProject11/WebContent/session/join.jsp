...
function postfind(){
	window.open("postfind.jsp","postfind","left=650, top=200 width=480,height=350,scrollbars=yes");
}
function idcheck(){
	window.open("idcheck.jsp","idcheck","left=700, top=150 width=380,height=230,scrollbars=no");
}
function join(){
	/*
		태그에 접근 window  		(계층구조, node...로 접근 해야 한다.(window 부터 접근은 생략이 가능))
				======
					|
				document
					|
	...
	*/
	//유효성 검사 /*생략*/ validation(스프링 내부에 있음)   ==> Spring 
				...
				<table class="table table-hover">
					<tr>
						...
						<td width=85%>
							...
							<input type="button" value="중복체크" class="btn btn-sm btn-warning" onclick="idcheck()">
						</td>
					</tr>
					<tr>
