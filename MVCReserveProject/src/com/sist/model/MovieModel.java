...
public class MovieModel {
	...
	public String move_theater(HttpServletRequest request, HttpServletResponse response){
	...
	public String movie_date(HttpServletRequest request,HttpServletResponse response){
		...
		request.setAttribute("lastDay", lastDay[month-1]);									// 일자 출력 끝
		request.setAttribute("week", week);													// 일자 출력 시작
	...
	public String movie_get_time(HttpServletRequest request, HttpServletResponse response){
	...
	public String movie_get_inwon(HttpServletRequest request, HttpServletResponse response){
	...
	/*
	 * 	MVC =>  Model 		:  ~VO,~DAO,~Model
	 * 			VIEW 		:	화면에 출력 (JSP)
	 * 								request				request=> 처리 내용을 첨부 (addAttribute())
	 * 			Controller	: 	사용자 요청을 받아서 => 요청 처리내용을 전송
	 * 							===============================
	 * 										배달
	 */
	...
	public String movie_admin(HttpServletRequest request, HttpServletResponse responase){
	...
	public String movie_mypage(HttpServletRequest request, HttpServletResponse responase){
		HttpSession session = request.getSession();
